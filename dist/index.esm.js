...
export const iconNames = ["home","menu","search","arrow-left","arrow-right","chevron-down","close","check","map-pin","user","users","lock","shield","plus","trash","edit","folder","calendar","download","upload","printer","link","settings","image","video","eye","eye-off","sun","moon","shopping-cart","star","bell","heart","mail","camera","share","alert-circle","info"];

export const iconCategories = ["Navigasi","User","Sistem","Media","Umum"];
